...
async function nomorhoki(nomer) {
    ...
    const { data } = await (0, axios_1.default)('https://www.primbon.com/no_hoki_bagua_shuzi.php', {
        method: 'POST',
        headers: {
    ...
    const results = data.split('</b><br></td></tr><tr><td')[0].split(`<br><b>No. HP : ${nomer}</b><br>`)[1];
    ...
    const positif = parseInt((_c = results.split('</b><br></td><td><!-- space -->')[0].split('b>% = ')[1]) === null || _c === void 0 ? void 0 : _c.replace(/&#37/gi, ''));
