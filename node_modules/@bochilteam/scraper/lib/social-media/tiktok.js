...
exports.tiktokstalk = exports.tiktokfyp = exports.tiktokdl = void 0;
...
async function tiktokdl(url) {
    ...
    let res = await axios_1.default.get(`https://api.snaptik.site/video-key?video_url=${url}`);
    let key = JSON.parse(JSON.stringify(res.data, null, 2));
    if (key.status !== 'success')
        throw key;
    let res2 = await axios_1.default.get(`https://api.snaptik.site/video-details-by-key?key=${key.data.key}`);
...
async function tiktokstalk(name) {
    ...
    let username = (_a = container.text()) === null || _a === void 0 ? void 0 : _a.trim();
    let avatar = $('span.tiktok-avatar.tiktok-avatar-circle.avatar > img').attr('src');
    let verified = /verified$/.test(container.attr('class'));
    let profile = (_b = $('h1.share-sub-title > span.profile').text()) === null || _b === void 0 ? void 0 : _b.trim();
    let stats = $('h2.count-infos > div.number');
    let following = (_c = stats.eq(0).find('strong').text()) === null || _c === void 0 ? void 0 : _c.trim();
    let followers = (_d = stats.eq(1).find('strong').text()) === null || _d === void 0 ? void 0 : _d.trim();
    let likes = (_e = stats.eq(2).find('strong').text()) === null || _e === void 0 ? void 0 : _e.trim();
    let description = (_f = $('h2.share-desc').text()) === null || _f === void 0 ? void 0 : _f.trim();
    return {
        username,
        profile,
        avatar,
